...
AD_CLOSE_UMA_PATH = "img/ad_close27.jpg"
...
def close_ad_img():
    ...
    if position:
        tap_on_device(990, 170)
    else:
        print()

def uma_ad_close():
    position = find_template_position(AD_CLOSE_UMA_PATH, threshold=0.9)
    if position:
        tap_on_device(1030, 130)
    else:
        print()